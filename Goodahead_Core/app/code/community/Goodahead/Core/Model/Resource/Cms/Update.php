...
class Goodahead_Core_Model_Resource_Cms_Update extends Mage_Core_Model_Mysql4_Abstract
{
    protected function _construct()
    {
        $this->_init('goodahead_core/cms_update', 'item_id');
        return $this;
    }
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($field == 'cms_item_id') {
            $select
                ->where('item_type = ?', $object->getData('item_type'))
                ->limit(1);
        }
